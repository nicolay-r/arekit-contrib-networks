...
from arekit_contrib_networks.embeddings.io_utils.np_based import NpEmbeddingIO
from arekit_contrib_networks.input.embedding.matrix import create_term_embedding_matrix
from arekit_contrib_networks.input.embedding.offsets import TermsEmbeddingOffsets
from arekit_contrib_networks.input.providers.sample import NetworkSampleRowProvider
from arekit_contrib_networks.pipelines.sampling.base import BaseSerializerPipelineItem
